...
public class First {
    public static void main(String[] args) {
        ...
        System.out.println("Ділення (перші три): " + (double)numbers[0]/numbers[1]/numbers[2]);
        System.out.println("--------------------");
        ...
        // Завдання 3: Масив об'єктів User
        User[] users = new User[10];
        // Ініціалізація через цикл (можна було б і вручну, але так "розумніше")
        ...
        // Завдання 5: Число навпаки (універсальний спосіб через цикл)
        int number = 412;
        int reversed = 0;
